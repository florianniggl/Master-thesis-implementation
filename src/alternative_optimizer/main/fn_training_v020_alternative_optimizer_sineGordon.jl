# ---------------------------------------------------------------------------------------------------------------------
# fn_training_v020_alternative_optimizer_sineGordon.jl is a MODIFICATION of training.jl from GeometricMachineLearning@v0.2.0
...
println("1D SINE GORDON EQUATION: ALTERNATIVE OPTIMIZER TRAINING")
println()
