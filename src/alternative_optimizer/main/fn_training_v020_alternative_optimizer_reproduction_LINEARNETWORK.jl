# ---------------------------------------------------------------------------------------------------------------------
# fn_training_v020_alternative_optimizer_reproduction_LINEARNETWORK.jl is a MODIFICATION of training.jl from GeometricMachineLearning@v0.2.0
...
println("1D WAVE EQUATION: ALTERNATIVE OPTIMIZER TRAINING OF LINEAR NETWORK")
println()
